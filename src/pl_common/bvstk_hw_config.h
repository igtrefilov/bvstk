#ifndef BVSTK_HW_CONFIG_H
#define BVSTK_HW_CONFIG_H

#include <stddef.h>
#include <stdint.h>

/*
 * Burevestnik PL contract exported by artifacts/fpga/design.xsa.
 *
 * This file is the single source of truth shared by the FreeRTOS and
 * Neutrino builds.  The FreeRTOS build validates these constants against
 * xparameters.h in platform/freertos/bvstk_hw_validate.c.
 */
