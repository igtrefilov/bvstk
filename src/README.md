...
## Оглавление
  ...
  - [Архитектура системы](#архитектура-системы)
    ...
    - [Потоки/задачи FreeRTOS](#потокизадачи-freertos)
  ...
  - [Сеть (lwIP)](#сеть-lwip)
    ...
    - [Настройка IP/MAC и сохранение](#настройка-ipmac-и-сохранение)
  ...
  - [Файловые системы (FatFs)](#файловые-системы-fatfs)
    ...
    - [Web UI в flash:/www/](#web-ui-в-flashwww)
  ...
  - [PL‑ядра](#pl-ядра)
    ...
    - [Очереди/ISR/worker tasks](#очередиisrworker-tasks)
    ...
    - [PL‑ядро I2C (bvstk_i2c)](#pl-ядро-i2c-bvstk_i2c)
      ...
      - [Управление (консоль/HTTP)](#управление-консольhttp)
    - [PL‑ядро SMI/MDIO (bvstk_smi)](#pl-ядро-smimdio-bvstk_smi)
      ...
      - [Управление (консоль/HTTP)](#управление-консольhttp-1)
  ...
  - [Веб‑ресурсы и деплой](#веб-ресурсы-и-деплой)
    - [Структура web/assets](#структура-webassets)
    - [Загрузка в flash:/www/](#загрузка-в-flashwww)
  - [Приложения](#приложения)
    - [Карта директорий](#карта-директорий)
    - [Таблица портов/протоколов](#таблица-портовпротоколов)
...
- **Web UI** (статика из `flash:/www/`) — см. раздел [Web UI в flash:/www/](#web-ui-в-flashwww).
