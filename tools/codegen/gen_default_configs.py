...
def main() -> int:
    ...
    parts: list[str] = []
    parts.append("#ifndef BVSTK_FREERTOS_DEFAULT_CONFIGS_H\n")
    parts.append("#define BVSTK_FREERTOS_DEFAULT_CONFIGS_H\n\n")
    ...
    parts.append("#endif /* BVSTK_FREERTOS_DEFAULT_CONFIGS_H */\n")
